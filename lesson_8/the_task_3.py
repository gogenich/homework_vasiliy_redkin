...
элемента и вносить его в список, только если введено число. Класс-исключение должен
не позволить пользователю ввести текст (не число) и отобразить соответствующее сообщение.
При этом работа скрипта не должна завершаться."""
nambers = []
while True:
    try:
        namber = input('введите число, либо команду stop: ')
        if namber == 'stop':
            print(nambers)
            break
        else:
        ...
        print('вы ввели строку вместо числа, попробуйте еще раз')
