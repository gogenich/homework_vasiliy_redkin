...
class Cell:
    ...
    def __str__(self):
        return f'количество ячеек = {self.number_of_cells}'

    def __add__(self, other):
        rezult = self.number_of_cells + other.number_of_cells
        return Cell(rezult)
    ...
    def __truediv__(self, other):
        rezult = int(self.number_of_cells / other.number_of_cells)
        return Cell(rezult)

    def make_order(self, nambers):
        rezult = ''
        for el in range(0, self.number_of_cells):
            rezult = rezult + '*'
            if (el+1) % nambers == 0:
                rezult = rezult + '\n'
        return rezult
